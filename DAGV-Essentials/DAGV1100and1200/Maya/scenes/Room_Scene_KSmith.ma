...
//Last modified: Fri, Feb 13, 2026 09:56:28 AM
//Codeset: 1252
...
fileInfo "UUID" "C80A257E-4126-734C-8A32-96BCDD8A0E0A";
createNode transform -s -n "persp";
	rename -uid "F2D9500F-4E44-A00F-A358-0986417DAE1A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.6433774974223319 6.0630635330969502 15.084809405854211 ;
	setAttr ".r" -type "double3" -23.138352729629531 -0.60000000000001763 4.9698891919644756e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "2A689A2D-4CEE-EEDD-9F5C-C2A2A1A0CEF2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.940254309208349;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DA3B7029-434F-D052-C157-43B55E84AD3D";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "74E1DD26-4E7A-8548-35E2-9E892F4F602F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EB156D67-4B68-3D26-1912-4C92975A514A";
createNode displayLayerManager -n "layerManager";
	rename -uid "F2E17C46-4062-2568-A542-08ADD3ADF418";
createNode displayLayer -n "defaultLayer";
	rename -uid "98882CE8-46B7-BBC8-C56A-34979D453E96";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5BBD6E7B-4F48-6D50-0539-909CC6BEFA1B";
...
createNode reference -n "Tall_Stool1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Tall_Stools|Tall_Stool1:Tall_Stool:Tall_Stool_1" "translate" " -type \"double3\" 0 0 -11.30615470953494395"
		
		2 "|Tall_Stools|Tall_Stool1:Tall_Stool:Tall_Stool_1" "rotate" " -type \"double3\" 0 90 0"
...
createNode reference -n "Tall_Stool1RN4";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Tall_Stools|Tall_Stool5:Tall_Stool:Tall_Stool_1" "translate" " -type \"double3\" -3.82065631566471708 0 1.96445938885194016";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "Tall_Stool1RN5";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Tall_Stools|Tall_Stool6:Tall_Stool:Tall_Stool_1" "translate" " -type \"double3\" -7.98815890626587866 0 2.13748152276551329";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "Tall_Stool1RN6";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Tall_Stools|Tall_Stool7:Tall_Stool:Tall_Stool_1" "translate" " -type \"double3\" -11.50598418423943414 0 2.28790310937500996";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
select -ne :time1;
	setAttr ".o" 1;
