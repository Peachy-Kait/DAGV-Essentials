...
//Name: Building with alley door finished uv.ma
//Last modified: Sat, Apr 25, 2026 08:58:42 PM
//Codeset: 1252
...
fileInfo "UUID" "4F76A65C-4A56-3A50-3431-EEB1BAD763F1";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 263.11175961707301 118.8459487969765 55.320743558081887 ;
	setAttr ".r" -type "double3" -19.53835273435477 -283.39999999990596 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "73030059-402C-C2CD-D949-31A7380D2162";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 309.30688625289656;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -27.998117594695128 20.493063329027414 11.659849070079535 ;
...
createNode transform -n "window" -p "group2";
	...
	setAttr ".t" -type "double3" -21.94104124206018 25.005950081489964 -10.859582193868793 ;
...
createNode mesh -n "windowShape" -p "window";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 8.5153247583877913 2.4995474996613272 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "3F26DC60-4D47-09D8-85DF-B99B2EE51CD4";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9877E177-4997-2152-01D6-259124324BA0";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "48F3D2F4-4ED5-983D-52D4-BE9EF5BA716C";
createNode displayLayerManager -n "layerManager";
	rename -uid "1B1412C2-4E0C-5B34-26A1-EE8F4B23CC42";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "75478CD2-4798-9F0E-B6C9-AC95619C15D3";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "36A8C51D-46DB-AEDC-9DFC-D28BA4FDA425";
...
createNode groupId -n "groupId13";
	rename -uid "D1719F20-42C3-439A-39C0-FA924E46DDDD";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts3";
	rename -uid "71E64E8E-422C-CEE9-171E-B88EA2E78093";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[5:9]";
createNode groupId -n "groupId14";
	rename -uid "156297F9-4B73-21F0-AD10-9AA1280D2282";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts4";
	rename -uid "6806DD3B-409D-67D2-1648-8BBDACD24F1C";
	setAttr ".ihi" 0;
...
createNode polyTweakUV -n "polyTweakUV9";
	...
	setAttr ".uopa" yes;
	setAttr -s 31 ".uvtk";
	setAttr ".uvtk[144]" -type "float2" 0.8037492 0 ;
	setAttr ".uvtk[145]" -type "float2" 0.8037492 1.8626451e-09 ;
	setAttr ".uvtk[146]" -type "float2" 0.81448901 1.8626451e-09 ;
	setAttr ".uvtk[147]" -type "float2" 0.81448901 0 ;
	setAttr ".uvtk[148]" -type "float2" 0.76166713 0 ;
	setAttr ".uvtk[149]" -type "float2" 0.76166713 1.8626451e-09 ;
	setAttr ".uvtk[150]" -type "float2" 0.8037492 1.5133992e-09 ;
	setAttr ".uvtk[151]" -type "float2" 0.81448901 1.5133992e-09 ;
	setAttr ".uvtk[152]" -type "float2" 0.75440419 0 ;
	setAttr ".uvtk[153]" -type "float2" 0.75440419 1.8626451e-09 ;
	setAttr ".uvtk[154]" -type "float2" 0.76166713 1.5133992e-09 ;
	setAttr ".uvtk[155]" -type "float2" 0.71104014 0 ;
	setAttr ".uvtk[156]" -type "float2" 0.71104014 1.8626451e-09 ;
	setAttr ".uvtk[157]" -type "float2" 0.75440419 1.5133992e-09 ;
	setAttr ".uvtk[158]" -type "float2" 0.70484507 0 ;
	setAttr ".uvtk[159]" -type "float2" 0.70484507 1.8626451e-09 ;
	setAttr ".uvtk[160]" -type "float2" 0.71104014 1.5133992e-09 ;
	setAttr ".uvtk[161]" -type "float2" 0.66489923 0 ;
	setAttr ".uvtk[162]" -type "float2" 0.66489923 1.8626451e-09 ;
	setAttr ".uvtk[163]" -type "float2" 0.70484507 1.5133992e-09 ;
	setAttr ".uvtk[164]" -type "float2" 0.65827668 0 ;
	setAttr ".uvtk[165]" -type "float2" 0.65827668 1.8626451e-09 ;
	setAttr ".uvtk[166]" -type "float2" 0.66489923 1.5133992e-09 ;
	setAttr ".uvtk[167]" -type "float2" 0.61256397 0 ;
	setAttr ".uvtk[168]" -type "float2" 0.61256397 1.8626451e-09 ;
	setAttr ".uvtk[169]" -type "float2" 0.65827668 1.5133992e-09 ;
	setAttr ".uvtk[170]" -type "float2" 0.60377777 0 ;
	setAttr ".uvtk[171]" -type "float2" 0.60377777 1.8626451e-09 ;
	setAttr ".uvtk[172]" -type "float2" 0.61256397 1.5133992e-09 ;
	setAttr ".uvtk[173]" -type "float2" 0.60377777 1.5133992e-09 ;
...
createNode polyTweakUV -n "polyTweakUV18";
	...
	setAttr ".uopa" yes;
	setAttr -s 13 ".uvtk";
	setAttr ".uvtk[346]" -type "float2" 0.050070852 0 ;
	setAttr ".uvtk[347]" -type "float2" 0.050070852 0 ;
	setAttr ".uvtk[348]" -type "float2" -0.091822267 0 ;
	setAttr ".uvtk[349]" -type "float2" -0.091822267 0 ;
	setAttr ".uvtk[350]" -type "float2" 0.091822296 0 ;
	setAttr ".uvtk[351]" -type "float2" 0.091821343 0 ;
	setAttr ".uvtk[352]" -type "float2" 0.050070852 0 ;
	setAttr ".uvtk[353]" -type "float2" -0.091822267 0 ;
	setAttr ".uvtk[354]" -type "float2" 0.091801763 0 ;
	setAttr ".uvtk[355]" -type "float2" 0.050070852 0 ;
	setAttr ".uvtk[356]" -type "float2" -0.091822267 0 ;
	setAttr ".uvtk[357]" -type "float2" 0.091798365 0 ;
...
createNode polyTweakUV -n "polyTweakUV19";
	...
	setAttr ".uopa" yes;
	setAttr -s 17 ".uvtk";
	setAttr ".uvtk[306]" -type "float2" 0.10522413 0.19061723 ;
	setAttr ".uvtk[307]" -type "float2" 0.084357023 0.16975012 ;
	setAttr ".uvtk[308]" -type "float2" 0.10646343 -0.13189602 ;
	setAttr ".uvtk[309]" -type "float2" 0.12733054 -0.11102891 ;
	setAttr ".uvtk[310]" -type "float2" 0.098159075 0.28702042 ;
	setAttr ".uvtk[311]" -type "float2" 0.077291965 0.26615319 ;
	setAttr ".uvtk[312]" -type "float2" -0.10485077 -0.019457668 ;
	setAttr ".uvtk[313]" -type "float2" -0.08274436 -0.32110381 ;
	setAttr ".uvtk[314]" -type "float2" 0.094779253 0.3331387 ;
	setAttr ".uvtk[315]" -type "float2" 0.073912144 0.31227121 ;
	setAttr ".uvtk[316]" -type "float2" -0.11191583 0.076945528 ;
	setAttr ".uvtk[317]" -type "float2" -0.11688566 -0.031492561 ;
	setAttr ".uvtk[318]" -type "float2" -0.094779253 -0.3331387 ;
	setAttr ".uvtk[319]" -type "float2" -0.11529505 0.12305572 ;
	setAttr ".uvtk[320]" -type "float2" -0.12395072 0.064910501 ;
	setAttr ".uvtk[321]" -type "float2" -0.12732983 0.11101952 ;
...
connectAttr "polyTweakUV15.out" "windowShape.i";
connectAttr "polyTweakUV15.uvtk[0]" "windowShape.uvst[0].uvtw";
...
// End of Building with alley door finished uv.ma
